...
* Foreleser: Hårek Haugerud, haugerud@oslomet.no, kontor SG214, SG29
* Hver fredag fra 14:30 - 16:15: Flipped classroom-forelesninger i P32 N002.107
* Hver påfølgende tirsdag fra 10:30 - 14:15: lab med oppgaveøvinger
...
* To kompendier dekker pensum
  * os.pdf
  * linux.pdf
  * Versjonene fra 2025 ligger under filer på Canvas og under Forelesninger på kurs-siden
...
## 1.12 Sentralt begrep: prosess

Prosess er et svært viktig Operativsystem-begrep.

---

## 1.12.1 Linux prosesser
...
* Et programs ånd/sjel
    * I en analogi hvor programmet som kjører er et menneskes DNA, hva vil prosessen være?
    * **Program**: = DNA
    * **Prosess**: = ??
    * **Hardware**: =
    * **OS**: =
...
## 1.13 Abstraksjon og hierarkier
...
## 1.13.1 Linux-eksempel på hierarki
...
## 1.16 Logiske porter og binær logikk
